/*
 * dhry_150m - app_ext CM4 app: Dhrystone 2.1 on the CM4 at 150 MHz,
 ...
 * CLKPATH0/FLL@100) and run dhry_main(). SCB5 UART is owned exclusively
...
int main(void)
{
    ...
    printf("\r\n=== Dhrystone 2.1 on PSoC6 [CM4] @ %lu Hz (XIP) ===\r\n",
