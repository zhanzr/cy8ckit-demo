#!/usr/bin/env bash
# Dual-core (CM0p + CM4) CoreMark 1.0 benchmark at 100 MHz.
...
INC=("-Isystem" "-Iext/cmsis" "-Ibench" "-Icoremark_1_0_1" "-I$DEVICES/include" "-I$DEVICES/include/ip" "-I$PDL/drivers/include")
...
CORE_DIR="coremark_1_0_1"
CORE_SRCS=("$CORE_DIR/core_list_join.c" "$CORE_DIR/core_main.c" "$CORE_DIR/core_matrix.c" "$CORE_DIR/core_state.c" "$CORE_DIR/core_util.c" "bench/core_portme.c" "bench/utils.c")
OBJS_CM0P=()
OBJS_CM4=()
