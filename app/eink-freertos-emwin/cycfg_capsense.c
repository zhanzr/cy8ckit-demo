...
static const cy_stc_capsense_widget_config_t cy_capsense_widgetConfig[CY_CAPSENSE_WIDGET_COUNT] =
{
    { /* Button0 */
        ...
        .posFilterConfig = 0u,
        .rawFilterConfig = 0u,
#if (CY_CAPSENSE_MW_VERSION >= 400) && (CY_CAPSENSE_MW_VERSION < 1000)
        .alpOnThreshold = 75u,
        .alpOffThreshold = 25u,
#endif
        ...
        .minFatFingerSizeHyst = 1u,
        .minLargeObjSizeHyst = 1u,
#endif
    },
    { /* Button1 */
...
cy_stc_capsense_tuner_t cy_capsense_tuner =
{
    ...
    .widgetContext = {
        { /* Button0 */
            ...
            #if (CY_CAPSENSE_MW_VERSION >= 1000)
                .calcTh = 40u,
                .offsetOuterEdge = 399u,
                .offsetInnerEdge = 290u,
                .fingerSigThMult = 160u,
                .minFatFingerSize = 4u,
                .minLargeObjectSize = 5u,
            #endif
            #if (CY_CAPSENSE_MW_VERSION >= 900)
                .reserved0 = 0u,
            #endif
        },
        { /* Button1 */
