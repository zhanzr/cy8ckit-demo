...
#define CY_CAPSENSE_MW_VERSION_MAJOR                    (10)
...
/** Middleware version */
#define CY_CAPSENSE_MW_VERSION                          (1000)
...
/** Liquid presence level 1 mask */
#define CY_CAPSENSE_WD_LIQUID_PRESENCE_LEVEL1_MASK      (0x100u)
/** Liquid presence level 2 mask */
#define CY_CAPSENSE_WD_LIQUID_PRESENCE_LEVEL2_MASK      (0x200u)
/** Liquid presence level 3 mask */
#define CY_CAPSENSE_WD_LIQUID_PRESENCE_LEVEL3_MASK      (0x400u)
/** Widget finger type mask */
#define CY_CAPSENSE_WD_FINGER_TYPE_MASK                 (0x3800u)
/** Widget finger type position */
#define CY_CAPSENSE_WD_FINGER_TYPE_POS                  (11u)
/** \} */
...
/******************************************************************************/
/** \addtogroup group_capsense_macros_ext_cref *//** \{ */
/******************************************************************************/
/** External Cref enable macro (fifth-generation CAPSENSE&trade; PSOC&trade; 4 HVMS only) */
#define CY_CAPSENSE_EXT_CREF_EN                         (CY_CAPSENSE_PLATFORM_BLOCK_FIFTH_GEN && \
                                                         CY_CAPSENSE_EXT_CREF_FEATURE_EN)

#if (CY_CAPSENSE_EXT_CREF_EN == CY_CAPSENSE_ENABLE)
    /** Internal CDAC used as Cref source */
    #define CY_CAPSENSE_CREF_SOURCE_INTERNAL            (0u)
    /** External capacitor used as Cref source */
    #define CY_CAPSENSE_CREF_SOURCE_EXTERNAL            (1u)
    /** Index of the CREF0 pin in the External Cref pin configuration array */
    #define CY_CAPSENSE_PIN_IDX_EXT_CREF0               (0u)
    /** Index of the CREF1 pin in the External Cref pin configuration array */
    #define CY_CAPSENSE_PIN_IDX_EXT_CREF1               (1u)
...
#if (CY_CAPSENSE_EXT_CREF_EN == CY_CAPSENSE_DISABLE)
/** Control mux switch state defined as CSX Negative Tx electrode */
#define CY_CAPSENSE_CTRLMUX_PIN_STATE_TX_NEGATIVE       (4u)
#else
/** Control mux switch state defined as External Cref pin 0 (replaces TX_NEGATIVE) */
#define CY_CAPSENSE_CTRLMUX_PIN_STATE_EXT_CREF0         (4u)
#endif
/* Working Group */
...
#else
/** Control mux switch state defined as External Cref pin 1 (replaces VDDA2) */
#define CY_CAPSENSE_CTRLMUX_PIN_STATE_EXT_CREF1         (7u)
#endif
...
/** Offset of raw count ALP filter enable mask */
#define CY_CAPSENSE_RC_FILTER_ALP_EN_OFFSET              (15u)

/** Mask of raw count filter history size */
#define CY_CAPSENSE_RC_FILTER_SNS_HISTORY_SIZE_MASK     ((uint32_t)(0x000FuL << CY_CAPSENSE_RC_FILTER_SNS_HISTORY_SIZE_OFFSET))
/** Median raw count filter enable mask */
#define CY_CAPSENSE_RC_FILTER_MEDIAN_EN_MASK            ((uint32_t)(0x0001uL << CY_CAPSENSE_RC_FILTER_MEDIAN_EN_OFFSET))
/** Median raw count filter mode mask */
#define CY_CAPSENSE_RC_FILTER_MEDIAN_MODE_MASK          ((uint32_t)(0x0003uL << CY_CAPSENSE_RC_FILTER_MEDIAN_MODE_OFFSET))
/** IIR raw count filter enable mask */
#define CY_CAPSENSE_RC_FILTER_IIR_EN_MASK               ((uint32_t)(0x0001uL << CY_CAPSENSE_RC_FILTER_IIR_EN_OFFSET))
/** IIR raw count filter mode mask */
#define CY_CAPSENSE_RC_FILTER_IIR_MODE_MASK             ((uint32_t)(0x0003uL << CY_CAPSENSE_RC_FILTER_IIR_MODE_OFFSET))
/** Average raw count filter enable mask */
#define CY_CAPSENSE_RC_FILTER_AVERAGE_EN_MASK           ((uint32_t)(0x0001uL << CY_CAPSENSE_RC_FILTER_AVERAGE_EN_OFFSET))
/** Average raw count filter mode mask */
#define CY_CAPSENSE_RC_FILTER_AVERAGE_MODE_MASK         ((uint32_t)(0x0003uL << CY_CAPSENSE_RC_FILTER_AVERAGE_MODE_OFFSET))
/** Raw count HW IIR filter enable mask */
#define CY_CAPSENSE_RC_HW_IIR_FILTER_EN_MASK            ((uint32_t)(0x0001uL << CY_CAPSENSE_RC_HW_IIR_FILTER_EN_OFFSET))
/** Raw count CM filter enable mask */
#define CY_CAPSENSE_RC_FILTER_CM_EN_MASK                ((uint32_t)(0x0001uL << CY_CAPSENSE_RC_FILTER_CM_EN_OFFSET))
/** Raw count ALP filter enable mask */
#define CY_CAPSENSE_RC_FILTER_ALP_EN_MASK               ((uint32_t)(0x0001uL << CY_CAPSENSE_RC_FILTER_ALP_EN_OFFSET))
...
#define CY_CAPSENSE_IIR_FILTER_STANDARD                 ((uint32_t)(1uL << CY_CAPSENSE_RC_FILTER_IIR_MODE_OFFSET))
/** Raw count IIR filter mode performance */
#define CY_CAPSENSE_IIR_FILTER_PERFORMANCE              ((uint32_t)(2uL << CY_CAPSENSE_RC_FILTER_IIR_MODE_OFFSET))
/** Raw count average filter mode */
#define CY_CAPSENSE_AVERAGE_FILTER_LEN_4                ((uint32_t)(2uL << CY_CAPSENSE_RC_FILTER_AVERAGE_MODE_OFFSET))
/** \} */
...
/** Liquid level multi level mask */
#define CY_CAPSENSE_LLW_MULTI_LEVEL_MASK                (0x1800u)
/** Liquid level multi level position */
#define CY_CAPSENSE_LLW_MULTI_LEVEL_POS                 (11u)
/** Finger type detection enable mask */
#define CY_CAPSENSE_FINGER_TYPE_DETECTION_MASK          (0x2000u)
...
/** Invalid value returned by \ref Cy_CapSense_GetLiquidWidgetPosition,
 *  \ref Cy_CapSense_GetLiquidPresenceLevel, and Cy_CapSense_GetFoamWidgetPosition()
 *  when a wrong widgetId is specified or the widget is not of the expected
 *  liquid level or liquid presence type */
#define CY_CAPSENSE_LLS_INVALID                         (0xFFFFu)
...
/******************************************************************************/
/** \addtogroup group_capsense_macros_liquid_presence *//** \{ */
/******************************************************************************/
/** No liquid presence level detected */
#define CY_CAPSENSE_LIQUID_PRESENCE_LEVEL_NONE           (0u)
/** Liquid presence level 1 detected */
#define CY_CAPSENSE_LIQUID_PRESENCE_LEVEL1               (1u)
/** Liquid presence level 2 detected */
#define CY_CAPSENSE_LIQUID_PRESENCE_LEVEL2               (2u)
/** Liquid presence level 3 detected */
#define CY_CAPSENSE_LIQUID_PRESENCE_LEVEL3               (3u)
/** \} */

/******************************************************************************/
/** \addtogroup group_capsense_macros_finger_type *//** \{ */
/******************************************************************************/
/** Finger type not detected */
#define CY_CAPSENSE_FINGER_TYPE_NONE                    (0u)
/** Normal finger type */
#define CY_CAPSENSE_FINGER_TYPE_NORMAL                  (1u)
/** Fat finger type */
#define CY_CAPSENSE_FINGER_TYPE_FAT                     (2u)
/** Large object finger type */
#define CY_CAPSENSE_FINGER_TYPE_LARGE_OBJECT            (3u)
/** \} */
