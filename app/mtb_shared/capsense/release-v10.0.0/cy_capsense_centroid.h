...
/******************************************************************************/
#define CY_CAPSENSE_MAX_FINGER_NUMBER_SUPPORTED         (3u)
...
typedef struct
{
    uint16_t peakIdx[CY_CAPSENSE_MAX_FINGER_NUMBER_SUPPORTED];
    uint16_t peakIdx1[CY_CAPSENSE_MAX_FINGER_NUMBER_SUPPORTED];
    uint16_t firstZoneIdx[CY_CAPSENSE_MAX_FINGER_NUMBER_SUPPORTED];
    uint16_t lastZoneIdx[CY_CAPSENSE_MAX_FINGER_NUMBER_SUPPORTED];
    uint8_t peakNum;
} cy_capsense_advanced_slider_t;
#endif
/** \} \endcond */
