...
typedef struct
{
    uint16_t dataParam0;                            /**< Parameter 0 context */
...
typedef struct
{
    ...
    uint16_t configParam3;                          /**< Parameter 3 configuration */
    uint16_t configParam4;                          /**< Parameter 4 configuration */
    uint16_t configParam5;                          /**< Parameter 5 configuration */
    uint8_t configParam6;                           /**< Parameter 6 configuration */
    uint8_t configParam7;                           /**< Parameter 7 configuration */
