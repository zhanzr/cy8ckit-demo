...
/* External Cref0 pin SW_SEL_CSW register value */
#define CY_CAPSENSE_EXT_CREF0_SW_SEL_CSW_VALUE \
((CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_SW_SNCA  << MSC_SW_SEL_CSW_SW_SNCA_Pos)  | \
 (CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_SW_SNCB  << MSC_SW_SEL_CSW_SW_SNCB_Pos)  | \
 (CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_SW_SNCC  << MSC_SW_SEL_CSW_SW_SNCC_Pos)  | \
 (CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_SW_SNCV  << MSC_SW_SEL_CSW_SW_SNCV_Pos)  | \
 (CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_SW_SNCG  << MSC_SW_SEL_CSW_SW_SNCG_Pos)  | \
 (CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_REF_MODE << MSC_SW_SEL_CSW_REF_MODE_Pos) | \
 (CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_ENABLED  << MSC_SW_SEL_CSW_ENABLED_Pos))

/* External Cref1 pin SW_SEL_CSW register value */
#define CY_CAPSENSE_EXT_CREF1_SW_SEL_CSW_VALUE \
((CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_SW_SNCA  << MSC_SW_SEL_CSW_SW_SNCA_Pos)  | \
 (CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_SW_SNCB  << MSC_SW_SEL_CSW_SW_SNCB_Pos)  | \
 (CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_SW_SNCC  << MSC_SW_SEL_CSW_SW_SNCC_Pos)  | \
 (CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_SW_SNCV  << MSC_SW_SEL_CSW_SW_SNCV_Pos)  | \
 (CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_SW_SNCG  << MSC_SW_SEL_CSW_SW_SNCG_Pos)  | \
 (CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_REF_MODE << MSC_SW_SEL_CSW_REF_MODE_Pos) | \
 (CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_ENABLED  << MSC_SW_SEL_CSW_ENABLED_Pos))

/* SW_SEL_CSW field values for External Cref0 pin */
#define CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_SW_SNCA                    (0x00uL)
#define CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_SW_SNCB                    (0x00uL)
#define CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_SW_SNCC                    (0x00uL)
#define CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_SW_SNCV                    (0x09uL)
#define CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_SW_SNCG                    (0x0AuL)
#define CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_REF_MODE                   (0x01uL)
#define CY_CAPSENSE_EXT_CREF0_REG_SW_SEL_CSW_FLD_ENABLED                    (0x01uL)

/* SW_SEL_CSW field values for External Cref1 pin */
#define CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_SW_SNCA                    (0x09uL)
#define CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_SW_SNCB                    (0x08uL)
#define CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_SW_SNCC                    (0x00uL)
#define CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_SW_SNCV                    (0x00uL)
#define CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_SW_SNCG                    (0x00uL)
#define CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_REF_MODE                   (0x01uL)
#define CY_CAPSENSE_EXT_CREF1_REG_SW_SEL_CSW_FLD_ENABLED                    (0x01uL)
...
/* Helper macros for swSelCswFunc template entries that depend on ext cref configuration */
#if (CY_CAPSENSE_EXT_CREF_EN == CY_CAPSENSE_DISABLE)
    #define CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC4_INDEX     CY_CAPSENSE_CTRLMUX_PIN_STATE_TX_NEGATIVE
    #define CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC4_VALUE     (CY_CAPSENSE_SM_REG_SW_SEL_CSW2_NEG_TX_VALUE)
    #define CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC7_INDEX     CY_CAPSENSE_CTRLMUX_PIN_STATE_VDDA2
    #define CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC7_VALUE     (CY_CAPSENSE_SM_REG_SW_SEL_CSW6_VDDA2_VALUE)
#else
    #define CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC4_INDEX     CY_CAPSENSE_CTRLMUX_PIN_STATE_EXT_CREF0
    #define CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC4_VALUE     (CY_CAPSENSE_EXT_CREF0_SW_SEL_CSW_VALUE)
    #define CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC7_INDEX     CY_CAPSENSE_CTRLMUX_PIN_STATE_EXT_CREF1
    #define CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC7_VALUE     (CY_CAPSENSE_EXT_CREF1_SW_SEL_CSW_VALUE)
#endif
...
#define CY_CAPSENSE_SENSING_METHOD_BASE_TEMPLATE            \
    {                                                   \
        ...
        { \
            ...
            [CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC4_INDEX] = CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC4_VALUE, \
            ...
            [CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC7_INDEX] = CY_CAPSENSE_TEMPLATE_SW_SEL_CSW_FUNC7_VALUE, \
