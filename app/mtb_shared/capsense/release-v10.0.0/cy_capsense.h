...
*     <td>20083</td>
*     <td>
*         CAPSENSE™ middleware has the Beta Version of the Liquid Level sensing feature, 
*         which might have an impact on the performance.
*     </td>
*     <td>
*         There is no workaround. This will be addressed in a future update.
*     </td>
*   </tr>
*   <tr>
*     <td>20238</td>
*     <td>
*         Under specific foam conditions near the sensors, when the foam is disturbed, 
*         differentiation between the liquid reference line and the foam level may be reduced.
*     </td>
*     <td>
*         There is no workaround. This will be addressed in a future update.
*     </td>
...
*       Also, if you use the CAPSENSE&trade; middleware v10.0.0, you must use
*       the CAPSENSE&trade; Configurator v11.0.0 or later. This MW version
*       is not compatible with the previous CAPSENSE&trade; Configurator versions.
*     </b></i>
*   </tr>
*   <tr>
*     <td> 
*         Added LLW multi-point presence/absence detection.
*     </td>
*     <td>
*         New feature support.
*     </td>
...
*   <tr>
*     <td> 
*         Expanded slider widget functionality. Added 5x5 centroid calculation,
*         fat finger detection, palm rejection, etc.
*     </td>
*     <td>
*         New feature support.
*     </td>
...
*   <tr>
*     <td> 
*         Changed the Cy_CapSense_IsTankRemoved() function prototype:
*         replaced the widget context pointer argument with widgetId
*         and CAPSENSE&trade; context pointer for API uniformity.
*     </td>
*     <td>
*         API uniformity improvement.
*     </td>
*   </tr>
*   <tr>
...
*
*   * <a href="https:/\/documentation.infineon.com/psoc6/docs/rkg1651145413836">
*   <b>PSOC&trade; 6 Documentation</b></a>
*
*   * <a href="https:/\/documentation.infineon.com/psoc4/">
*   <b>PSOC&trade; 4 Documentation</b></a>
*
*   * <a href="https:/\/www.infineon.com/row/public/documents/30/42/infineon-an210781-getting-started-with-psoc-6-mcu-with-bluetooth-low-energy-ble-connectivity-applicationnotes-en.pdf"><b>AN210781 Getting Started with
*   PSOC&trade; 6 MCU with Bluetooth Low Energy (BLE) Connectivity</b></a>
*
*   * <a href="https:/\/www.infineon.com/row/public/documents/30/42/infineon-an215671-psoc-6-mcu-firmware-design-for-ble-applications-applicationnotes-en.pdf"><b>AN215671 PSOC&trade; 6 MCU
...
*
*   * <a href="https:/\/www.infineon.com/assets/row/public/documents/30/57/infineon-psoc4000s-architecture-trm-additionaltechnicalinformation-en.pdf?fileId=8ac78c8c7d0d8da4017d0f915c737eb7">
*   <b>PSOC&trade; 4000S Family: PSOC&trade; 4 Architecture Technical Reference Manual (TRM)</b></a>
*
*   * <a href="https:/\/www.infineon.com/row/public/documents/30/57/infineon-psoc-4100s-and-psoc-4100s-plus-architecture-trm-additionaltechnicalinformation-en.pdf">
