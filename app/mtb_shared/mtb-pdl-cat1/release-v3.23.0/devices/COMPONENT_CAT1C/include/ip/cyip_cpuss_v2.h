...
typedef struct {
  ...
  __IOM uint32_t CM7_1_NMI_CTL[4];              /*!< 0x00000640 CM7 1 NMI control */
   __IM uint32_t RESERVED9[109];
   __IM uint32_t CM7_2_STATUS;                  /*!< 0x00000804 CM7 2 status */
  __IOM uint32_t FAST_2_CLOCK_CTL;              /*!< 0x00000808 Fast 2 clock control */
  __IOM uint32_t CM7_2_CTL;                     /*!< 0x0000080C CM7 2 control */
   __IM uint32_t RESERVED10[60];
   __IM uint32_t CM7_2_INT_STATUS[16];          /*!< 0x00000900 CM7 2 interrupt status */
   __IM uint32_t RESERVED11[48];
  __IOM uint32_t CM7_2_VECTOR_TABLE_BASE;       /*!< 0x00000A00 CM7 2 vector table base */
   __IM uint32_t RESERVED12[15];
  __IOM uint32_t CM7_2_NMI_CTL[4];              /*!< 0x00000A40 CM7 2 NMI control */
   __IM uint32_t RESERVED13[109];
   __IM uint32_t CM7_3_STATUS;                  /*!< 0x00000C04 CM7 3 status */
  __IOM uint32_t FAST_3_CLOCK_CTL;              /*!< 0x00000C08 Fast 3 clock control */
  __IOM uint32_t CM7_3_CTL;                     /*!< 0x00000C0C CM7 3 control */
   __IM uint32_t RESERVED14[60];
   __IM uint32_t CM7_3_INT_STATUS[16];          /*!< 0x00000D00 CM7 3 interrupt status */
   __IM uint32_t RESERVED15[48];
  __IOM uint32_t CM7_3_VECTOR_TABLE_BASE;       /*!< 0x00000E00 CM7 3 vector table base */
   __IM uint32_t RESERVED16[15];
  __IOM uint32_t CM7_3_NMI_CTL[4];              /*!< 0x00000E40 CM7 3 NMI control */
   __IM uint32_t RESERVED17[108];
  ...
  __IOM uint32_t CM7_2_PWR_CTL;                 /*!< 0x00001220 CM7 2 power control */
  __IOM uint32_t CM7_2_PWR_DELAY_CTL;           /*!< 0x00001224 CM7 2 power delay control */
   __IM uint32_t RESERVED23[2];
  __IOM uint32_t CM7_3_PWR_CTL;                 /*!< 0x00001230 CM7 3 power control */
  __IOM uint32_t CM7_3_PWR_DELAY_CTL;           /*!< 0x00001234 CM7 3 power delay control */
   __IM uint32_t RESERVED24[50];
  ...
  __IOM uint32_t CM0_PC3_HANDLER;               /*!< 0x0000204C CM0+ protection context 3 handler */
   __IM uint32_t RESERVED36[29];
  __IOM uint32_t PROTECTION;                    /*!< 0x000020C4 Protection status */
   __IM uint32_t RESERVED37[14];
