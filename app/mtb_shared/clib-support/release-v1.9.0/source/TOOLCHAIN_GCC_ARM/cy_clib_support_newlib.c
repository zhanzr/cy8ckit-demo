...
// Some devices already define this, so don't redefine for those devices
#if (!defined(COMPONENT_CAT3)) && (!defined(CY_SBRK_DEFINED))
//--------------------------------------------------------------------------------------------------
// _sbrk
//--------------------------------------------------------------------------------------------------
...
#endif // #if (!defined(COMPONENT_CAT3)) && (!defined(CY_SBRK_DEFINED))
