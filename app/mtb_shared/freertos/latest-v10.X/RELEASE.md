...
Since CVE-2024-28115 vulnerability was find in FreeRTOS v 10.5.004, it is strongly recommended to use latest 10.6.202 version.
...
- Minor updates to CM33 *FreeRTOSConfig.h* template to enhance support
  Non-TrustZone and TrustZone flows
- Documentations enhancements
