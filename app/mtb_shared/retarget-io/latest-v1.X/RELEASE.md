...
### Compatibility Notes
This library is not compatible with other libraries that also redirect the standard I/O (stdio) functionality. Using multiple libraries that each attempt to redirect stdio will result in conflicting behavior. Examples of such libraries include BTSPY. Only one stdio-redirecting library should be used in a given application.

### What Changed?
#### v1.10.0
* Added support for custom retarget implementation with COMPONENT_RETARGET_IO_CUSTOM.
...
* [Reference Manual](https://infineon.github.io/retarget-io/html/index.html)
...
---
© Copyright 2018-2026 Infineon Technologies Apache2
