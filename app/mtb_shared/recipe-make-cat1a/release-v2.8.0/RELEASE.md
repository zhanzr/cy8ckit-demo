# PSOC™ 6 and XMC5000 GNU make Build System Release Notes
This repo provides the build recipe make files and scripts for building and programming PSOC™ 6 and XMC5000 applications. Builds can be run either through a command-line interface (CLI) or through a supported IDE such as Eclipse or VS Code.

### What's Included?
This release of the PSOC™ 6 and XMC5000 GNU make build recipe includes complete support for building, programming, and debugging PSOC™ 6 and XMC5000 application projects. It is expected that a code example contains a top level make file for itself and references a Board Support Package (BSP) that defines specific items, like the PSOC™ 6 or XMC5000 part, for the target board. Supported functionality includes the following:
...
### What Changed?
#### v2.8.0
* Improved project export support for Keil uVision and IAR Embedded Workbench.
...
#### v2.7.0
* Added support for XMC5000 MCUs.
* Changed default floating-point setting to VFP_SELECT=hardfp for IAR Embedded Workbench exports.
* Enhanced project export for uVision and IAR Embedded Workbench with improved configuration handling.
